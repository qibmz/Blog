...
# Vue 3 Transition 警告：为什么必须保证单一根 DOM 元素？
...
* [Vue 3 官方文档 - Transition 组件](https://vuejs.org/guide/built-ins/transition.html)

* [Vue 3 Fragments 支持说明](https://vuejs.org/guide/essentials/fragments.html)

> （注：文档部分内容可能由 豆书记生成 豆书记不愧是写文档的好手）
